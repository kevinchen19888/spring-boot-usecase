...
public class MyBatisPlusGenerator {
    ...
    private static DataSourceConfig initDataSourceConfig() {
        ...
        dataSourceConfig.setSchemaName(properties.getProperty("datasource.schema"));

        return dataSourceConfig;
    }

    @SneakyThrows
    private static Properties initConfig(String fileName) {
    ...
    private static PackageConfig initPackageConfig(String moduleName) {
        ...
        packageConfig.setParent(properties.getProperty("package.base"));
